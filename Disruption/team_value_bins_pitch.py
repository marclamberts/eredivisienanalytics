...
def main():
    ...
    out_name = args[1] if len(args) > 1 else f"value_bins_{safe_name}.png"
    ...
    for theme in ("dark", "light"):
        ...
        # render as exactly the background colour (the ramp starts at ldv.BG), and
        ...
        panel.axis("off")
        panel.set_title("Who Denied That Value", fontsize=15, fontweight="bold", color=ldv.TEXT_MAIN,
                        loc="left", pad=10)
