...
image per page -- same deliverable shape as the Slavia template (a
ReportLab-built widescreen PDF, one chart per page).
...
PDF_PATH = os.path.join(OUT_DIR, "Hradec_Kralove_vs_Pardubice_PostMatch.pdf")
