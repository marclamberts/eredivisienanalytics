"""
Shared data loading + parsing for the FC Hradec Králové vs Beşiktaş
Jimnastik Kulübü post-match report (European qualifier, leg 1 of 2,
2026-08-06).
...
relatedMatchId and aggregateId, confirming it's leg 1 of a two-legged
European tie (Beşiktaş won 0-1 away). COMPETITION below is therefore
deliberately generic ("European Qualifier, Leg 1 of 2") rather than a
guessed UEFA competition name.

Team IDs cross-checked against the goal-scorer contestantId and the
0-1 final score in matchDetails/scores/ft.
...
AWAY_NAME = "Beşiktaş Jimnastik Kulübü"
