"""
Shared data loading + parsing for the FC Hradec Králové vs FC Viktoria
Plzeň pre-match preview (Chance liga, CZ 2026-2027, matchday 5,
2026-08-23).
...
against its 2-1 score, and (2) both fixture teams' IDs also appear in
"CZ 2026-2027 Matches.csv" as the matchday-5 contestants, which
additionally supplies this fixture's venue/date/kickoff (no matching
event feed exists for that match yet, since it is still days away of
"today").
